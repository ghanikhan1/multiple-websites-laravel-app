<section id="her" class="bg-curvy-light-mode dark:bg-curvy-dark-mode bg-no-repeat bg-contain bg-bottom">
    <!--  Hero container -->
    <div class="container mx-auto px-6 text-center md:pt-20 pb-52">
        <img src="{{ asset('assets/fylo/images/illustration-intro.png') }}" alt="" class="mx-auto">
